package pl.simonduraj.blooddonor.data;
...
import pl.simonduraj.blooddonor.util.AndroidComponentUtil;
import pl.simonduraj.blooddonor.util.NetworkUtil;
...
public class SyncService extends Service {
    ...
    public void onCreate() {
        super.onCreate();
        DonorApplication.get(this).getComponent().inject(this);
    }
