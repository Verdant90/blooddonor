package pl.simonduraj.blooddonor.ui.base;
...
import pl.simonduraj.blooddonor.injection.component.ActivityComponent;
import pl.simonduraj.blooddonor.injection.component.ConfigPersistentComponent;
import pl.simonduraj.blooddonor.injection.component.DaggerConfigPersistentComponent;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (configPersistentComponent == null) {
            ...
            configPersistentComponent = DaggerConfigPersistentComponent.builder()
                    .applicationComponent(DonorApplication.get(this).getComponent())
                    .build();
